...
import { clearCurrentUser, setCurrentUser, loginFailed, setLoading, signUpFail } from './user.actions';
import userTypes from './user.types';
import { signUp, signIn, getUserProfile, getCurrentUser } from '../../services/user';
